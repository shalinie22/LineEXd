...
//   displayImage(file)
  ...
  fetch("https://a3e6-34-145-159-228.ngrok-free.app/runcode", {
    method: "POST",
    body: formData,
  })
...
function fetchFiles() {
    fetch('https://a3e6-34-145-159-228.ngrok-free.app/download_files',{
        // mode:'no-cors'
        method: "POST",
        body: "Get the files",
    })
...
function parseJSONFileAndCreateTable(jsonfile) {
  fetch('https://a3e6-34-145-159-228.ngrok-free.app/json',{
    method: "POST",
    body: jsonfile
