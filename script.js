...
//   displayImage(file)
  ...
  fetch("https://d152-34-87-58-188.ngrok-free.app/runcode", {
    method: "POST",
    body: formData,
  })
...
function fetchFiles() {
    fetch('https://d152-34-87-58-188.ngrok-free.app/download_files',{
        // mode:'no-cors'
        method: "POST",
        body: "Get the files",
    })
...
function parseJSONFileAndCreateTable(jsonfile) {
  fetch('https://d152-34-87-58-188.ngrok-free.app/json',{
    method: "POST",
    body: jsonfile
