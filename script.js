...
//   displayImage(file)
  ...
  fetch("https://676d-35-203-137-126.ngrok-free.app/runcode", {
    method: "POST",
    body: formData,
  })
...
function fetchFiles() {
    fetch('https://676d-35-203-137-126.ngrok-free.app/download_files',{
        // mode:'no-cors'
        method: "POST",
        body: "Get the files",
    })
...
function parseJSONFileAndCreateTable(jsonfile) {
  fetch('https://676d-35-203-137-126.ngrok-free.app/json',{
    method: "POST",
    body: jsonfile
